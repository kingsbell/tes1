              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action ="" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" id="loginBtn" value ="Login" name ="proseslog">Masuk</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Tidak mempunyai akun? <a href="pages-register.php">Daftar</a></p>
                    </div>
                  </form>
                  <?php
