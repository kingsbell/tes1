              ...
              <div class="accordion accordion-flush" id="faq-group-1">
                ...
                <div class="accordion-item">
                  ...
                  <div id="faqsOne-3" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                      Kelebihan Lampu Jenis LED. Kelebihan utama dari lampu jenis LED adalah jauh lebih hemat energi dibandingkan dengan lampu pijar dan lampu bohlam standar sedangkan
                      Kekurangan Lampu LED. Lampu jenis LED tidak tahan apabila terkena panas dalam waktu yang lama.
                    </div>
                  </div>
                </div>
              ...
              <div class="accordion accordion-flush" id="faq-group-2">
                ...
                <div class="accordion-item">
                  ...
                  <div id="faqsTwo-3" class="accordion-collapse collapse" data-bs-parent="#faq-group-2">
                    <div class="accordion-body">
                      Karena Smart Lamp ini memiliki fitur untuk merubah pencahayaan dan warna.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsThree-3" type="button" data-bs-toggle="collapse">
                      Apa Untungnya Menggunakan Smart Lamp ?
                    </button>
                  </h2>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsThree-4" type="button" data-bs-toggle="collapse">
                     Apa Bedanya Smart Lampu dan Lampu Biasa ?
                    </button>
                  </h2>
